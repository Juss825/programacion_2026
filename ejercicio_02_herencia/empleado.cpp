...
std::string Empleado::obtenerNombre() const { return nombre; }
std::string Empleado::obtenerId() const { return id; }
float Empleado::obtenerSalarioBase() const { return salarioBase; }
